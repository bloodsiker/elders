    ...
    <div class="intro-y box xl:col-span-8">
        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
            ...
            <div id="anchor" class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                <a href="#anchor" "{{--route('change-learning-format', ['child' => $child['id']])--}}" class="btn btn-warning w-24 mr-1 mb-2" disabled="disabled">
                    Змінити
                </a>
            </div>
        </div>
            ...
            <div class="preview" style="display: block; opacity: 1;">
                <table class = "resp-tab">
                    ...
                    <tr>
                        ...
                        <th class="border border-b-2 dark:border-dark-5 whitespace-nowrap">I семестр</th>
                        <th class="border border-b-2 dark:border-dark-5 whitespace-nowrap">II семестр</th>
                    </tr>
                    </thead>
                    <tbody>
