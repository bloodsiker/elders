<!-- BEGIN: Mobile Menu -->
<div class="mobile-menu xl:hidden" style="border-color: transparent !important;">
    <div class="mobile-menu-bar">
        <a href="" class="flex mr-auto">
            <img alt="Rubick Tailwind HTML Admin Template" src="{{ asset('dist/img/logo.png') }}">
        </a>
        <a href="#" id="mobile-menu-toggler1">
            <i data-feather="bar-chart-2" class="w-8 h-8 text-white transform -rotate-90"></i>
        </a>
    </div>
    <ul id="mobileNav" class="border-t border-theme-29 py-5 hidden" style="border-color: transparent !important;">
