                    ...
                    <div class="col-span-12 mt-5">
                        <div class="intro-y block sm:flex items-center h-10">
                            <div class="flex">
                                ...
                                <a href="#" onclick="return false;" class="btn-green active">Items</a>
                            ...
                            <table class="table table-report sm:mt-2">
                                ...
                                @foreach ($location->items as $item)
                                    <tr class="intro-x">
                                        <td>
                                            <div class="flex">
                                                <div class="text-gray-600 text-xs whitespace-nowrap mt-0.5">{{ $item->id }}</div>
                                            </div>
                                        </td>
                                        <td class="w-40">
                                            <div class="flex">
                                        ...
                                        <td class="w-5 table-report__action">
                                            <a class="flex items-center text-theme-6" href="{{ route('admin.location.item.delete', ['id' => $location->id, 'item_id' => $item->id]) }}">
    ...
    <div id="addItem" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('admin.location.item.add', ['id' => $location->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
                        <h2 class="font-medium text-base mr-auto">Добавить item</h2>
                    </div>
