    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="col-span-12 lg:col-span-8 xxl:col-span-9">
            <div class="grid grid-cols-12 gap-6">
                    ...
                    <div class="tiny-slider py-5" id="announcement">
                        <div class="px-5">
                            ...
                            <div class="flex items-center mt-5">
                                <div class="px-3 py-2 bg-theme-14 dark:bg-dark-5 dark:text-gray-300 text-theme-10 rounded font-medium">02 June155 2021</div>
                ...
                <!-- END: Latest Tasks -->
                <!-- BEGIN: SettingGeneral Statistics -->
                <div class="intro-y box col-span-12 xxl:col-span-6">
                    <div class="flex items-center px-5 py-5 sm:py-3 border-b border-gray-200 dark:border-dark-5">
                            ...
                            <div class="dropdown mt-3 sm:mt-0 mr-auto sm:mr-0">
                                ...
                                <div class="dropdown-menu w-40">
                                    <div class="dropdown-menu__content box dark:bg-dark-1 p-2 overflow-y-auto h-32">
                                        ...
                                        <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md">February11</a>
                                        ...
                                        <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md">June033</a>
